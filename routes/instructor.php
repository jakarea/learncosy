...
Route::domain('{subdomain}.' . $domain)->middleware(['web', 'auth', 'verified', 'role:instructor'])->group(function () {
    ...
    Route::group(['middleware' => ['subscription.check']], function () {
        ...
        Route::get('/instructor/lesson/extension', [CourseController::class,'showLessonExtension'])->name('course.lesson.extension');
        ...
        Route::get('instructor/courses/create/{id}/video/{module_id}/content/{lesson_id}/remove', [CourseCreateStepController::class, 'stepLessonVideoRemove']);
