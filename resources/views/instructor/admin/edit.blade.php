        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="create-form-wrap">
                    ...
                    <form action="{{route('updateInstructorProfile',$instructor->id)}}" method="POST" class="create-form-box" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-error">
                                            ...
                                            <select name="user_role" id="user_role" class="form-control @error('user_role') is-invalid @enderror">
                                                <option value="students" {{ $instructor->user_role == 'students' ? 'selected' : '' }}>Students</option>
                                                <option value="instructor" {{ $instructor->user_role == 'instructor' ? 'selected' : '' }}>Instructor</option>
                                            </select> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-error">
                                            ...
                                            <input type="text" placeholder="Enter short bio" name="short_bio"
                                                ...
                                                value="{{ $instructor->short_bio }}" id="short_bio">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Social Link" name="social_links[]"
                                                ...
                                                id="features" multiple value="{{ $instructor->social_links }}">
