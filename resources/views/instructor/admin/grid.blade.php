        ...
        <div class="product-filter-box mt-0">
            ...
            <div class="form-grp-btn mt-4 ms-auto">
                <a href="{{ url('admin/instructor/create') }}" class="btn me-3"><i
                        class="fas fa-user-plus text-white me-2"></i>Add Instructor</a>
            </div> 
        </div> 
    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
            <div class="user-grid-box">
                <div class="header-action">
                    <ul>
                        <li><a href="{{ url('admin/instructor/'.$user->id.'/edit') }}"><i class="fas fa-pen"></i></a></li>
                        <li>
                            <form method="post" class="d-inline" action="{{ url('admin/instructor/'.$user->id.'/destroy') }}">
                                @csrf 
                                @method("DELETE")
