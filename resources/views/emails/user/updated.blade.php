        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="body-table">
                    <tr>
                        <td>
                            <h4><span>Your profile has been updated successfuly!</span></h4>
                        </td>
                    </tr> 
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p style="margin-top: 1rem">Thank you for staying with Learncosy. We hope you are having a great experience!</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center">
                            <h5>Profile updated at: {{$user->updated_at}}</h5>
                        </td>
                    </tr>
                </table>
            </td>
