                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 col-xl-8">
                                    <div class="logo-box-view">
                                        ...
                                        @else
                                        <img src="{{asset('latest/assets/images/logo-view.svg')}}" alt="a" class="img-fluid">
                                        @endif
                                        <input type="file" name="logo" id="file-upload" class="form-control  @error('logo') is-invalid @enderror">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="flexSwitchCheckChecked" name="send_message_by_enter" value="1" {{ old('send_message_by_enter', $module_settings->value->send_message_by_enter ?? '') == 1 ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="feat-box">
                                ...
                                <div class="col-lg-12 col-12 col-xl-4">
                                    <div class="meta-box">
                                        ...
                                        <h6>Meta Title</h6>
                                        <input type="text" class="form-control"  name="meta_title" id="meta_title" value="{{ old('meta_title', $module_settings->value->meta_title ?? '')}}" class="form-control @error('meta_title') is-invalid @enderror">
                                        <span class="invalid-feedback">@error('meta_title'){{ $message }} @enderror</span>
                                        ...
                                        <span class="invalid-feedback">@error('meta_desc'){{ $message }} @enderror</span>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="file-prev">
                                                <div id="file-previews">
                                                    <img src="{{ asset('assets/images/setting/'.$module_settings->favicon) }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                        @endif
