                    ...
                    <div class="theme-settings-wrap">
                        ...
                        <form action="{{ route('module.setting.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="theme-settings-box theme-dns-settings-box"
                                style="padding: 2rem!important; margtin-top: 2rem!important;">
                                <div class="row">
                                    <div class="col-lg-12 col-12 col-xl-8">
                                        <div class="logo-box-view">
                                            ...
                                            <div class="media align-items-center flex-column flex-lg-row">
                                                <label for="app_logo" class="file-upload-area file-upload-2 mt-1">
                                                    ...
                                                    <p class="mt-2"><span>Click to upload</span> SVG, PNG, JPG, or GIF
                                                        <br> (max. 300x300px)</p>
                                                </label>
                                                ...
                                                <input type="file" name="app_logo" id="app_logo" accept="image/*"
                                                    onchange="previewImage5()" class="form-control d-none  ">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="color-position">
                                                    <input type="color" class="form-control p-0" name="primary_color"
                                                        id="primary_color"
                                                        value="{{ old('primary_color', $module_settings->value->primary_color ?? '#ffffff') }}"
                                        ...
                                        <div class="certificate-style-box login-page-theme-box border-0">
                                            ...
                                            <input type="radio" class="d-none" id="default" name="lp_layout"
                                                value="default">
        ...
        function handleFileUpload(inputElement, containerId, labelId) {
            ...
            reader.onload = function() {
                ...
                closeIcon.addEventListener("click", function() {
                    ...
                    "block"; // Show the label again after removing the uploaded image
                });
