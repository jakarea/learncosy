                    ...
                    <div class="header">
                        <ul class="nav nav-pills main-navigator" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $tab == 'dns' ? '' : 'active' }} tab-link" id="pills-home-tab" data-bs-toggle="pill"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-12 col-xl-4">
                                                        <div class="meta-box">
                                                            ...
                                                            <h6>Meta Title</h6>
                                                            <input autocomplete="off" type="text" class="form-control" name="meta_title"
                                                                id="meta_title"
