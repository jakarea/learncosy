...
<body> 
    ...
    <div class="main-wrapper">
        <div class="container">
            <div class="main-bg">
                <img src="{{ public_path('latest/assets/images/certificate/one/one.png') }}" alt="Certificate-bg"
            ...
            <div class="logo-area">
                ...
                @else 
                    <img src="{{ public_path('latest/assets/images/certificate/one/logo.png') }}" alt="Logo" class="img-fluid">
                @endif 
            </div>
            <div class="asset-area">
                <img src="{{ public_path('latest/assets/images/certificate/one/checkmark.png') }}" alt="CHK" class="img-fluid">
            </div>
