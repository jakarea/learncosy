            ...
            <div class="col-lg-8">
                <div class="user-profile-picture">
                    ...
                    <div class="cover-img" id="coverImgContainer">
                        @if ($user->cover_photo) 
                            <img src="{{ asset($user->cover_photo) }}" alt="Cover Photo" class="img-fluid cover-img" id="coverImg">
                        @else 
                            <img src="{{ asset('latest/assets/images/cover.svg') }}" alt="Cover Photo" class="img-fluid cover-img" id="coverImg">
                        @endif

                        <input type="file" class="d-none" id="coverImage" accept="image/png, image/jpeg, image/svg+xml" name="cover_photo">
                        <div class="ol-upload">
            ...
            <div class="col-lg-4">
                ...
                <div class="contact-info-box mt-4">
                    ...
                    <div class="media">
                        ...
                        <img src="{{ asset('latest/assets/images/icons/twitter.svg') }}" alt="twitter"
                            class="img-fluid">
