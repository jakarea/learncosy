...
<main class="course-page-wrap">
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-5 col-lg-4">
                        ...
                        <div class="accordion-header" id="heading_{{$module->id}}">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex">
                                    <p>{{ $module->title }}
                                        @can('admin') 
                                            <a href="{{url('admin/modules/'.$module->slug.'/edit')}}" class="ms-2"><i class="fa-regular fa-pen-to-square text-info"></i></a>
                                        @endcan
                                    </p>
                            ...
                            <div class="accordion-body"> 
                                <ul class="lesson-wrap">
                                    ...
                                    <li>
                                        ...
                                        @can('admin') 
                                            <a href="{{url('admin/lessons/'.$lesson->slug.'/edit')}}"><i class="fa-regular fa-pen-to-square text-info"></i></a>
                                        @endcan
                                    </li>
                                    @endforeach
                                </ul>
                                <div class="text-center">
                                    <a href="{{ url('admin/lessons/create?course='.$course->id.'&module='.$module->id) }}"
            ...
            <a href="{{ url('admin/modules/create?course='.$course->id) }}" class="add_module_bttn">Add Module </a> 
        </div>
