                            ...
                            <div class="actions module-dropdown-box">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <form action="{{ route('admin.module.destroy', $module->slug) }}" method="post"
                                            class="d-inline">
                                            @csrf
                                            @method('delete')
                                            <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ url('admin/courses/create/'.$lesson->course_id.'/audio/'.$lesson->module_id.'/content/'.$lesson->id) }}">Add Content</a>
                                            @elseif($lesson->type == 'video')
                                            <a class="dropdown-item"
                                                href="{{ url('admin/courses/create/'.$lesson->course_id.'/video/'.$lesson->module_id.'/content/'.$lesson->id) }}">Add Content </a>
                                            @elseif($lesson->type == 'text')
                                            <a class="dropdown-item"
                                                href="{{ url('admin/courses/create/'.$lesson->course_id.'/text/'.$lesson->module_id.'/content/'.$lesson->id) }}">Add  Content </a> 
                                        ...
                                        <form action="{{ route('admin.lesson.destroy', $lesson->slug) }}" method="post"
                                            class="d-inline">
                                            @csrf
                                            @method('delete')
                                            <li>
