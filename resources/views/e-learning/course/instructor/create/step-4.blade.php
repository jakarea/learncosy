                ...
                <div class="col-12 col-md-8 col-lg-4 col-xl-3">
                    ...
                    <div class="course-create-step-wrap page-create-step">
                        <div class="step-box current">
                            ...
                            <p><a href="{{ url('admin/courses/create', optional(request())->route('id')) }}">Contents</a>
                            </p>
                        </div>
                        <div class="step-box">
                            <span class="circle"></span>
                ...
                <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="lesson-edit-form-wrap course-content-box course-page-edit-box flex-column mt-2 align-items-start"
                        ...
                        <div class="title d-flex w-100 justify-content-between">
                            <div class="media">
                                <img id="audio-thumbnail" src="{{ asset('latest/assets/images/icons/big-audio.svg') }}"
                                    alt="Audio" class="img-fluid" style="width: 2rem">
                    ...
                    @if ($lesson->audio)
                        ...
                        <div class="lesson-edit-form-wrap course-content-box course-page-edit-box flex-column mt-2 align-items-start"
                            ...
                            <div class="title d-flex w-100 justify-content-between">
                                ...
                                <div>
                                    <a href="{{ url('instructor/courses/create/' . $lesson->course_id . '/audio/' . $lesson->module_id . '/content/' . $lesson->id . '/remove') }}"
                                        class="text-danger">
...
@endif
                            ...
                            @if ($lesson->lesson_file)
                                <div
                                    class="lesson-edit-form-wrap course-content-box course-page-edit-box flex-column mt-2 align-items-start">
                                    <h4>Current Lesson File:</h4>
                                    <div class="title d-flex w-100 justify-content-between">
                                        <div class="media">
                                            <img id="audio-thumbnail"
                                                src="{{ asset('latest/assets/images/icons/file.svg') }}" alt="Audio"
                                                class="img-fluid" style="width: 2rem">
                                            <div class="media-body">
                                        ...
                                        <div>
                                            <a href="{{ url('instructor/courses/create/' . $lesson->course_id . '/file/' . $lesson->module_id . '/content/' . $lesson->id . '/remove') }}"
                                                class="text-danger">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        window.location.href = baseUrl + '/instructor/courses/create/' +
                            courseId + '/lesson/' + moduleId + '/institute/' + lessonId;
                    },
