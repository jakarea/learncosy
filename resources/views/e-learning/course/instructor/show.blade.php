                            ...
                            <div class="accordion-header" id="heading_{{$module->id}}">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                        <p>{{ $module->title }}</p>
                                        @can('instructor') 
                                            <a href="{{url('instructor/modules/'.$module->slug.'/edit')}}" class="ms-2"><i class="fa-regular fa-pen-to-square text-primary"></i></a>
                                        @endcan
                                    </div>
                                </button>
                            </div>
                                    ...
                                    <ul class="lesson-wrap">
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                @can('instructor') 
                                                    <a href="{{url('instructor/lessons/'.$lesson->slug.'/edit')}}"><i class="fa-regular fa-pen-to-square text-primary ms-2"></i></a>
                                                @endcan
                                            </div>
