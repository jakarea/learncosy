                            ...
                            @foreach ($likeCourses as $likeCourse)
                                <div class="media">
                                    @if ($likeCourse->course->thumbnail)
                                        <img src="{{ asset($likeCourse->course->thumbnail) }}" alt="a"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p><strong>Fee:</strong>
                                            ...
                                            {{ $likeCourse->course->offer_price ? $likeCourse->course->offer_price : $likeCourse->course->price }}
                                            €
                                        </p>
                                        <ul class="mt-1">
                    ...
                    @foreach (studentRadarChart(auth()->user()->id)['labels'] as $key => $label)
                        <div class="col-lg-12">
                            <div class="course-progress-content mt-15">
                                ...
                                <ul>
                                    <li><span><i class="fas fa-circle-info"></i> Lesson</span>
                                        <span>{{ studentRadarChart(auth()->user()->id)['lesson'][$key] }}</span>
                                    </li>
                                    <li><span><i class="fas fa-circle-info"></i> Module</span>
                                        <span>{{ studentRadarChart(auth()->user()->id)['modules'][$key] }}</span>
                                    </li>
