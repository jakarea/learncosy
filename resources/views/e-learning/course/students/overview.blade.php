    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="share-on-social-wrap mt-0">
            ...
            <div class="d-flex">
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ url('students/courses/overview',$course->slug)}}"
                    target="_blank">
                ...
                <a href="https://www.linkedin.com/shareArticle?url={{ url('students/courses/overview',$course->slug)}}" target="_blank">
                    <img src="{{asset('latest/assets/images/icons/linkedin-ic.svg')}}" alt="FB"
                        class="img-fluid">
                    <span>LinkedIn</span>
                </a>
                <a href="https://twitter.com/intent/tweet?url={{ url('students/courses/overview',$course->slug)}}&text={{ $course->title }}"
            ...
            <div class="d-flex">
                ...
                <a href="https://www.messenger.com/share.php?text={{ url('students/courses/overview',$course->slug) }}">
                    <img src="{{asset('latest/assets/images/icons/messenger.svg')}}" alt="FB" class="img-fluid">
                    <span>Messenger</span>
                </a>
                <a href="https://api.whatsapp.com/send?text={{ url('students/courses/overview',$course->slug) }}">
                    <img src="{{asset('latest/assets/images/icons/wapp.svg')}}" alt="FB" class="img-fluid">
                    <span>Whatsapp</span>
                </a>
                <a href="https://telegram.me/share/url?url={{ url('students/courses/overview',$course->slug) }}">
            ...
            <div class="copy-link">
                <input type="text" placeholder="Link" value="{{ url('students/courses/overview', $course->slug)}}"
