            ...
            <div class="col-12">
                <div class="package-list-header package-header-2">
                    ...
                    <div class="bttn text-end">
                        <a href="{{url('admin/modules')}}" class="common-bttn">All Modules</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="subscription-package-form">
                    <form action="{{route('admin.module.update',$module->slug)}}" method="POST" class="create-form-box">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="pending" {{ $module->status == 'pending' ? 'selected' : ''}}>Unpublish</option>
