        ...
        <div class="row">
            <div class="col-12">
                <div class="user-add-form-wrap">
                    <form action="{{route('admin.lesson.store')}}" method="POST" class="create-form-box" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-lg-6"> 
                                <div class="form-group">
                                    ...
                                    <input type="file" name="lesson_file" id="thumbnail" class="form-control">
                                </div> 
                            </div>
                            <div class="col-md-12">
