                    ...
                    <form action="" method="GET" id="myForm">
                        <div class="package-list-header">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" placeholder="Search Lesson" class="form-control" name="title"
                            ...
                            <div class="bttn">
                                <a href="{{ url('instructor/lessons/create') }}" class="common-bttn"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ url('instructor/lessons/' . $lesson->slug . '/edit') }}"
                                                    class="me-r"><img
                                                        src="{{ asset('latest/assets/images/icons/edit.svg') }}"
                                                        alt="Icon" class="img-fluid"></a>

                                                <form method="post" class="d-inline"
                                                    action="{{ url('instructor/lessons/' . $lesson->slug . '/destroy') }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
