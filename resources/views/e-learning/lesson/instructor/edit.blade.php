                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6"> 
                                        ...
                                        <div id="image-container" class="mt-0">
                                            ...
                                            @if ($lesson->thumbnail)
                                                <img  src="{{asset('assets/images/lessons/'.$lesson->thumbnail)}}" alt="thumbnail" class="img-fluid static-image">
                                                @else 
                                    ...
                                    <div class="col-lg-6"> 
                                        ...
                                        <div id="image-container2" class="mt-0">
                                            ...
                                            @if ($lesson->lesson_file)
                                                <img  src="{{asset('assets/images/lessons/'.$lesson->lesson_file)}}" alt="thumbnail" class="img-fluid static-image2">
                                                @else 
