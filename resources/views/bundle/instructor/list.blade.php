    ...
    <div class="create-client-wrap page-height-wrapper">
        <div class="create-client-head table-filter-sort-wrap mb-4">
            ...
            <div class="create-bttn-wraps ms-auto">
                <a href="{{url('instructor/bundle/courses/create')}}"><i class="fa-regular fa-square-plus"></i> Create New Bundle Course</a>
            </div>
                ...
                <div class="client-single-box-wrap">
                    ...
                    <div class="client-thumb-box">
                        ...
                        <div class="client-name-box">
                           <a href="{{url('instructor/bundle/courses/'.$course->slug)}}"><h4>{{ Str::limit($course->title, $limit = 45, $end = '..') }}</h4></a>
                    ...
                    <div class="client-txt-box">
                        <hr>
                        <div class="d-flex"> 
                            <a href="{{url('instructor/bundle/courses/'.$course->slug)}}">View <i class="fas fa-eye text-primary"></i></a>
                            <a href="{{url('instructor/bundle/courses/'.$course->slug.'/edit')}}">Edit <i class="fas fa-pen text-info"></i></a> 
