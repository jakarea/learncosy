...
@section('title') Bundle Course create @endsection
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="basic-info-txt">
                                    ...
                                    <p>Quickly introduce your course info to students by filling in course information.</p>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="bundle-create-inputs">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Bundle Course Name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="0" aria-label="price" aria-describedby="price">
                                      </div>
