                    ...
                    <div class="card-box on-progress-box">
                        ...
                        <div class="chart-slider">
                            <div class="slider-item">
                                <div class="mb-2">
                                    <img src="{{asset('dashboard-assets/images/graph-3.svg')}}" alt="Graph"
                                        class="img-fluid">
                                </div>
            ...
            <div class="card-box important-projects-box">
                ...
                <div class="banner-projects-box">
                    <div class="row">
                        <div class="col-lg-7 col-12 col-sm-6">
                            <div class="media">
                                <img src="{{asset('dashboard-assets/images/company-logo/k-logo.svg')}}" alt="Logo"
                                    class="img-fluid">
                                <div class="media-body">
                                    <h5>Kleon Studios</h5>
                                    <p>Creative Agency</p>
                            ...
                            <div class="bottom-box">
                                ...
                                <ul>
                                    <li><img src="{{asset('dashboard-assets/images/small-avatar.svg')}}"
                                            alt="Small Avatar" class="img-fluid"></li>
                                    <li><img src="{{asset('dashboard-assets/images/small-avatar.svg')}}"
                                            alt="Small Avatar" class="img-fluid"></li>
                                    <li><img src="{{asset('dashboard-assets/images/small-avatar.svg')}}"
                                            alt="Small Avatar" class="img-fluid"></li>
                ...
                <div class="all-projects-wrap">
                    ...
                    <div class="project-box brdr-top">
                        <div class="media">
                            <img src="{{asset('dashboard-assets/images/company-logo/fillow.svg')}}" alt="Logo"
                                class="img-fluid">
                            <div class="media-body">
                                <h5>Fillow Team</h5>
                                <p>Creative Agency</p>
                    ...
                    <div class="project-box brdr-left brdr-top">
                        <div class="media">
                            <img src="{{asset('dashboard-assets/images/company-logo/c-logo.svg')}}" alt="Logo"
                                class="img-fluid">
                            <div class="media-body">
                                <h5>Codebyte Base</h5>
                    ...
                    <div class="project-box brdr-top">
                        <div class="media">
                            <img src="{{asset('dashboard-assets/images/company-logo/cafe.svg')}}" alt="Logo"
                                class="img-fluid">
                            <div class="media-body">
                                <h5>Ombe Cafe</h5>
                                <p>Cafe</p>
