    ...
    <div class="product-filter-wrapper my-0">
        <div class="product-filter-box mt-0">
            ...
            <div class="form-grp-btn mt-0 ms-auto">
                <a href="{{ url('instructor/students') }}" class="btn me-3"><i class="fas fa-list"></i> All Students</a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="productss-list-box payment-history-table instructor-details-box mt-0 mb-4">
                        <h5>Details :</h5>
                        <p>{{$student->description ? $student->description : 'No Description Available'}}</p> 
                    </div>
                </div> 
                <div class="col-12">
