        ...
        <div class="row">
            <div class="col-12">
                <div class="user-add-form-wrap">
                    <form action="{{route('admin.student.add')}}" method="POST" class="profile-form create-form-box"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group form-error">
                                    ...
                                    <input autocomplete="off" type="text" name="company_name" id="company_name" value="{{ old('company_name') }}"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group form-error">
                                    ...
                                    <input autocomplete="off" type="text" name="website" id="website" value="{{ old('website') }}"
