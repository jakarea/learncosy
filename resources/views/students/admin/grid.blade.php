            ...
            <div class="row">
                <div class="col-lg-7 col-xl-9">
                    <div class="user-search-box-wrap">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" placeholder="Search Students" class="form-control"
                ...
                {{-- <div class="col-lg-3 col-xl-2">
                    <div class="user-add-box">
                        <a href="{{ url('admin/students/create') }}"><img src="{{ asset('latest/assets/images/user-plus.svg') }}" alt="User" class="img-fluid"> Add Students</a>
                    </div>
                </div> --}}
            </div>
        </form>
