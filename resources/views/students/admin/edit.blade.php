                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group form-error">
                                        ...
                                        <textarea name="short_bio" id="short_bio" class="form-control @error('short_bio') is-invalid @enderror"
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div id="imageContainer">
                                        ...
                                        @if ($student->avatar)
                                            <img src="{{ asset($student->avatar) }}" alt="logo" class="img-fluid">
                                        @endif
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="recivingMessage"
                                                        ...
                                                        {{ $student->recivingMessage == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="recivingMessage"
                                                        ...
                                                        {{ $student->recivingMessage == 0 ? 'checked' : '' }}>
